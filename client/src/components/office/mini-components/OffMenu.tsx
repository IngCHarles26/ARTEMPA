...
const {inventory,requirements,services_register,services_status} = appRoutes
  ...
  },
  {
    image: (hover:boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" className={"w-9 transition-all "
        ...
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/> <path d="M10 17l4 -4" /> <path d="M14 3v4a1 1 0 0 0 1 1h4" /> <path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /> <path d="M10 13h.01" /> <path d="M14 17h.01" />
      </svg>
      ),
    name: 'avance',
