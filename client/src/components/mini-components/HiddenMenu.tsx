...
function HiddenMenu() {
  ...
  return (
    <button 
      onClick={handleClick}
      className={`fixed bottom-0 stroke-neutral-800 stroke-2  transition-all hover:scale-110 z-20
        ${ width > 700 ? 'hidden' : ''} ${ menuHidden ? 'left-0' : 'left-14'}
      `}>
      {
        menuHidden 
        ? <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-layout-sidebar-left-expand w-10" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        : <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-layout-sidebar-right-expand w-10" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round">
