...
function HiddenMenu() {
  ...
  return (
    <button 
      ...
      {
        menuHidden 
        ? <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-layout-sidebar-left-expand w-12" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        : <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-layout-sidebar-right-expand w-12" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round">
