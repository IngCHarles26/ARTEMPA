...
function MenuHomeCard(props:Props) {
  ...
  return (
    <div  
      ...
      onClick={handleClick}
      className="border-2 text-cyan-900 border-neutral-600 cursor-pointer w-36 h-44 p-4 rounded-xl transition-all hover:border-cyan-500 hover:shadow-lg hover:text-cyan-500 hover:stroke-cyan-500">
      {Image(hover)}
